...
public class GameJsonSerializer : ISerializer<GameField>
{
    public void Serialize(GameField data, string filePath)
    {
        ...
        var json = System.Text.Json.JsonSerializer.Serialize(gameState, new JsonSerializerOptions { WriteIndented = true });
